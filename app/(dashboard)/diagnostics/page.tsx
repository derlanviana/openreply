...
const QUEUE_LABELS: Record<string, string> = {
  waiting: "Fila aguardando",
  active: "Fila em andamento",
  delayed: "Fila agendada",
  failed: "Fila com falha",
};
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            Saúde do sistema, filas, falhas de webhook, eventos de cobrança e alertas do worker.
          </p>
        </div>
        <button
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Section title="Falhas e DMs ignoradas das campanhas">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Section title="Falhas na renovação do token">
          {data?.tokenRefreshFailures.length ? (
            ...
            <EmptyState label="Nenhuma falha na renovação do token." />
          )}
        </Section>

      </div>

      <Section title="Linha do tempo de eventos">
