  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            {connectedCount}{" "}
            {connectedCount === 1 ? "conta conectada" : "contas conectadas"}
            {" · "}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-4">
        ...
        <StatCard label="Taxa de cliques" value={`${stats?.ctrThisMonth ?? 0}%`} />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-4 sm:gap-6">
        ...
        <div className="lg:col-span-3 panel rounded p-4 sm:p-6">
          <h2 className="text-sm font-semibold text-foreground mb-6">DMs nos últimos 7 dias</h2>
        ...
        <div className="lg:col-span-1 panel rounded p-4 sm:p-6">
          <h2 className="text-sm font-semibold text-foreground mb-4">Top palavras-chave</h2>
          <div className="space-y-3">
            {stats?.topKeywords.length === 0 && (
              <p className="text-sm text-muted py-8">Nenhuma palavra-chave acionada ainda</p>
            )}
